...
const FormControlPinInput = forwardRef(({
  name,
  label,
  length = 4,
  className = '',
...
FormControlPinInput.displayName = 'FormControlPinInput';

export default FormControlPinInput;
